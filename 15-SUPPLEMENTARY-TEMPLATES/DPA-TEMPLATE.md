...
**10.1** Upon termination of the services or upon written instruction by the Controller, the Processor shall, at the Controller's choice:
(a) Delete all Personal Data and certify such deletion in writing; or
(b) Return all Personal Data to the Controller in a commonly used format
